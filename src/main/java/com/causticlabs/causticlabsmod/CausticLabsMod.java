...
public class CausticLabsMod
{
    ...
    public void onEvent(FMLPreInitializationEvent event) {
        ...
        GameRegistry.addRecipe(new ShapedTConToolRecipe(
            " A",
            "B ", anyHatchetHead, "materialRod"));
        GameRegistry.addRecipe(new ShapedTConToolRecipe(
            " A",
            "B ", anyShovelHead, "materialRod"));
        GameRegistry.addRecipe(new ShapedTConToolRecipe(
            "A C",
            " B ", anyHatchetHead, "materialRod", anyShovelHead));
        GameRegistry.addRecipe(new ShapedTConToolRecipe(
            "A",
            "C",
            "B", anyPickaxeHead, "materialRod", "materialBinding"));
        GameRegistry.addRecipe(new ShapedTConToolRecipe(
            "A",
            "C",
            "B", anyKnifeBlade, "materialRod", anyCrossbar));
        GameRegistry.addRecipe(new ShapedTConToolRecipe(
            " A",
            "CB", anyBowLimb, new ItemStack(TinkerWeaponry.bowstring), anyBowLimb));
        GameRegistry.addRecipe(new ShapedTConToolRecipe(
            "A",
        ...
        GameRegistry.addRecipe(new ShapelessUseTConToolRecipe(new ItemStack(Blocks.planks, 1, 0), 20, new ItemStack(Blocks.log, 1, 0), anyHatchet));
        GameRegistry.addRecipe(new ShapelessUseTConToolRecipe(new ItemStack(Blocks.planks, 1, 1), 20, new ItemStack(Blocks.log, 1, 1), anyHatchet));
        GameRegistry.addRecipe(new ShapelessUseTConToolRecipe(new ItemStack(Blocks.planks, 1, 2), 20, new ItemStack(Blocks.log, 1, 2), anyHatchet));
        GameRegistry.addRecipe(new ShapelessUseTConToolRecipe(new ItemStack(Blocks.planks, 1, 3), 20, new ItemStack(Blocks.log, 1, 3), anyHatchet));
        GameRegistry.addRecipe(new ShapelessUseTConToolRecipe(new ItemStack(Blocks.planks, 1, 4), 20, new ItemStack(Blocks.log2, 1, 0), anyHatchet));
        GameRegistry.addRecipe(new ShapelessUseTConToolRecipe(new ItemStack(Blocks.planks, 1, 5), 20, new ItemStack(Blocks.log2, 1, 1), anyHatchet));

        GameRegistry.addRecipe(new ShapelessUseTConToolRecipe(new ItemStack(Items.stick, 2), 10, "plankWood", anyHatchet));

        GameRegistry.addRecipe(new ShapelessUseTConToolRecipe(new ItemStack(TinkerTools.crossbar, 1), 10, "stickWood", anyHatchet));
    }
